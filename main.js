...
//EVENT LISTENERS
//   let pokeball = document.querySelector("#box-tilt");

//   let pokemans = document.querySelector(".pokemon");

// pokeball.addEventListener("click", function(){
//   pokemans.classList.toggle("hidden");
// })

//     let pokeball = document.querySelector("#box-tilt");
//   let test = document.querySelectorAll(".pokemon");
...
let pokeball = document.getElementsByClassName("box");
let test = document.querySelectorAll(".pokemon");

function pokePop() {
  // for(var j=0; j<test.length; j++){
  // test[j].classList.toggle("hidden");
  alert("dog");
  event.target.pokemon.classList.toggle("show");
  alert("Passed!");
  // event.target.child.classList.toggle("hidden");
  // }
}
...
for (var i = 0; i < pokeball.length; i++) {
  pokeball[i].addEventListener("click", function () {
    // pokePop();
    pokeball[i].classList.toggle("show");
  });
}
